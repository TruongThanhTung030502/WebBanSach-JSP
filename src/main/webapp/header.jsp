		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="<%=url%>/san-pham">Trang chủ</a></li>
				<li class="nav-item"><a class="nav-link" href="#">Combo
						giảm giá</a></li>
				<li class="nav-item"><a class="nav-link"
					href="crudsan-pham">Sản Phẩm</a></li>
				<li class="nav-item dropdown"><a
					...
					<%-- 	<c:forEach items="${listd}" var="o">
							...
							<li><a class="dropdown-item" href="#"></a>${o.tenTheLoai}</li>
						</c:forEach> --%>
					</ul></li>
			...
			<form action="tim-kiem" method="post" class="d-flex" role="search">
				<input  value="${txtS }" name="timKiem" class="form-control me-2" type="txt"
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 bg-infor ">
					<li class="nav-item dropdown dropstart"><a
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="/Bai4_Boostrap/don-hang">Đơn
									hàng của tôi</a></li>
							<li><a class="dropdown-item" href="#">Thông báo</a></li>
							<li><a class="dropdown-item"
								href="<%=url%>/khachhang/thaydoianh.jsp">Thay đổi ảnh avtar
							</a></li>
							<li><a class="dropdown-item"
