			...
			if (baoLoi.length() > 0) {
				...
				if (khachHang != null) {
					...
					KhachHang kh = new KhachHang(maKhachHang, "", "", hoVaTen, gioiTinh, diaChiKhachHang,
							...
							dongYNhanMail != null);
//					KhachHang kh=new KhachHang(maKhachHang, baoLoi, maKhachHang, hoVaTen, gioiTinh, diaChiKhachHang, diaChiNhanHang
//							, diaChiMuaHang, null, dienThoai, email, false);
	...
	public static String getNoiDung(KhachHang kh) {
		String link = "http://localhost:8080/Bai4_Boostrap/khach-hang?hanhDong=xac-thuc&maKhachHang="+kh.getMaKhachHang()+"&maXacThuc="+kh.getMaXacThuc();
