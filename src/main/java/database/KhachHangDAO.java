	...
	public ArrayList<KhachHang> selectAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				Date thoigianhieulucMaXacThuc = rs.getDate("thoigianhieuluccuamaxacthuc");
...
//	KhachHang tg = tgd.selectById(new KhachHang("KH1", null, null, null, null, null, null, null, null, null, null, false));
