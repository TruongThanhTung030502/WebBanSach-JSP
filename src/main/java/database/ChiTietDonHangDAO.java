	...
	public ArrayList<ChiTietDonHang> selectAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				DonHang dh = new DonHangDAO().selectById(new DonHang(madonhang, null, "", "", "", "", masanpham, 0, 0, null, null));
...
//	ChiTietDonHang tg = tgd.selectById(new ChiTietDonHang("MCT1", null, null, 0, 0, 0, 0, 0, 0));
